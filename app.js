/* ============================================================
   ...
   - Adds: swipe guard so scroll gestures don’t trigger choices
   ============================================================ */
...
const TAP = {
  ...
  moved: false,
  active: false,
  thresholdPx: 10, // tune: 8–14 works well
};
...
/* ============================================================
   ...
   - Now guarded: ignore clicks if the gesture was a scroll.
   ============================================================ */
document.addEventListener("click", async (e) => {
  // If this click came after a scroll-like gesture, ignore it.
  if(TAP.moved){
    return;
  }
