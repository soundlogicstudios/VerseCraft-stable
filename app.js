/* ============================================================
   ...
   - Fix: DEFAULT_PLAYER is now module-agnostic (no Lorecraft items baked in)
...
const DEFAULT_PLAYER = () => ({
  hp: { cur: 15, max: 15 },        // app currently renders "HP" bar; story modules may treat this as Reputation, etc.
...
/* ============================================================
   ...
   - story.module.loadout supports:
     {
       weapon: { id, name, category },  // category optional; defaults by slot
       armor:  { id, name, category },
       special:{ id, name, category }
     }
   - Items are added to inventory and equipped into the matching slot.
   ============================================================ */
...
This is the demo’s reminder: when your primary resource hits zero, the run ends.
